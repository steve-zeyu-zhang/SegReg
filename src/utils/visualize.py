...
color_dict = {
    1: {'color': [128, 0, 128], 'name': 'A_Carotid_L'},
    2: {'color': [187, 255, 187], 'name': 'A_Carotid_R'},
    3: {'color': [0, 255, 0], 'name': 'Arytenoid'},
    4: {'color': [50, 55, 255], 'name': 'Bone_Mandible'},
    5: {'color': [0, 0, 255], 'name': 'Brainstem'},
    6: {'color': [155, 128, 0], 'name': 'BuccalMucosa'},
    7: {'color': [0, 50, 0], 'name': 'Cavity_Oral'},
    8: {'color': [200, 155, 0], 'name': 'Cochlea_L'},
    9: {'color': [176, 224, 230], 'name': 'Cochlea_R'},
    10: {'color': [55, 220, 55], 'name': 'Cricopharyngeus'},
    11: {'color': [0, 150, 0], 'name': 'Esophagus_S'},
    12: {'color': [128, 64, 64], 'name': 'Eye_AL'},
    13: {'color': [50, 150, 155], 'name': 'Eye_AR'},
    14: {'color': [75, 200, 15], 'name': 'Eye_PL'},
    15: {'color': [0, 255, 255], 'name': 'Eye_PR'},
    16: {'color': [55, 175, 50], 'name': 'Glnd_Lacrimal_L'},
    17: {'color': [255, 0, 255], 'name': 'Glnd_Lacrimal_R'},
    18: {'color': [125, 64, 250], 'name': 'Glnd_Submand_L'},
    19: {'color': [255, 0, 128], 'name': 'Glnd_Submand_R'},
    20: {'color': [0, 128, 128], 'name': 'Glnd_Thyroid'},
    21: {'color': [255, 255, 0], 'name': 'Glottis'},
    22: {'color': [255, 128, 0], 'name': 'Larynx_SG'},
    23: {'color': [128, 64, 64], 'name': 'Lips'},
    24: {'color': [90, 128, 0], 'name': 'OpticChiasm'},
    25: {'color': [50, 100, 255], 'name': 'OpticNrv_L'},
    26: {'color': [255, 0, 100], 'name': 'OpticNrv_R'},
    27: {'color': [200, 55, 50], 'name': 'Parotid_L'},
    28: {'color': [255, 100, 57], 'name': 'Parotid_R'},
    29: {'color': [0, 100, 0], 'name': 'Pituitary'},
    30: {'color': [0, 0, 100], 'name': 'SpinalCord'}
...
def generate_image_niis(raw_img, raw_mask, save_dir, filename='combined_segmentation.nii.gz'):
    '''
    Generate a NIfTI image file with all organ segmentations applied, 
    and save it into the specified save_dir with the provided filename.
    '''
    ...
    combined_mask = merge_masks(raw_mask)

    print("raw_mask shape: ", raw_mask.shape)
    
    # Convert the numpy array to a SimpleITK Image
    sitk_image = sitk.GetImageFromArray(combined_mask.astype(np.int8))

    # Write the SimpleITK Image to a NIfTI file
    sitk.WriteImage(sitk_image, os.path.join(save_dir, filename))
